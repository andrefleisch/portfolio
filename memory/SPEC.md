...
- Gap is the visual centerpiece with three interactive iPhone screenshot slots using the supplied real app screens in this order: Home / START WITH TIME, Tasks / SMART RECOMMENDATION, and New Task / CONTEXT & PRIORITY. The Tasks screen is central and visually prominent, with an in-page case-study expansion.
